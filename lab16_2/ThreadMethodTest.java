...
class MyThread extends Thread {
	...
	public void run(){
		for(int i = 0; i < 5; i++) {
			...
			try {
				sleep(500);  //Thread 이기 때문에 Thread.필요없다.
...
public class ThreadMethodTest {
	public static void main(String[] args) throws InterruptedException {  //sleep과 join부분에서 interruptedException이 발생한다.
		System.out.println("lab16_2: 정은애");
		System.out.print("\n어서오세요.");
